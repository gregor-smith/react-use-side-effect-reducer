...
export declare function getSideEffect(update: NoUpdate): null;
export declare function getSideEffect(update: RegularUpdate<any>): null;
export declare function getSideEffect<TState, TAction>(update: SideEffectUpdate<TState, TAction>): SideEffect<TState, TAction>;
export declare function getSideEffect<TState, TAction>(update: UpdateWithSideEffect<TState, TAction>): SideEffect<TState, TAction>;
